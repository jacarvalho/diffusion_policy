...
@click.option('-n', '--num_inference_steps', default=25)
def main(checkpoint, output_dir, device, num_inference_steps):
    # remap output dir
    output_dir = os.path.join(output_dir, f'DDIM-{num_inference_steps}')
    ...
    del cfg.policy.noise_scheduler.variance_type
